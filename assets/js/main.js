...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateEpisode(episodeNumber) {
        ...
        if (iframe) {
            iframe.src = 'https://player2.anitype.fun/?player=anitype&translation=AniLibria.TV&id=52299&episode=' + episodeNumber + '&startFrom=72';
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateEpisode(episodeNumber) {
        ...
        if (iframe) {
            iframe.src = 'https://player2.anitype.fun/?player=anitype&ambient=200&translation=2x2&id=20&episode=' + episodeNumber + '&season=1';
        }
        var episodeTitleElement = document.querySelector('.episode-number');
        if (episodeTitleElement) {
            episodeTitleElement.textContent = episodeNumber + ' эпизод';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateEpisode(episodeNumber) {
        ...
        if (iframe) {
            iframe.src = 'https://player2.anitype.fun/?player=anitype&ambient=200&translation=AniLibria.TV&id=51180&episode=' + episodeNumber + '&season=1';
        }
        var episodeTitleElement = document.querySelector('.episode-number');
        if (episodeTitleElement) {
            episodeTitleElement.textContent = episodeNumber + ' эпизод';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateEpisode(episodeNumber) {
        ...
        if (iframe) {
            iframe.src = 'https://player2.anitype.fun/?player=anitype&ambient=200&translation=AniLibria.TV&id=35849&episode=' + episodeNumber + '&season=1';
        }
        var episodeTitleElement = document.querySelector('.episode-number');
        if (episodeTitleElement) {
            episodeTitleElement.textContent = episodeNumber + ' эпизод';
