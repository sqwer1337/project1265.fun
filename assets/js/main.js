...
function toggleVisibility() {
    // Получаем элементы по их классу
    var mains = document.querySelectorAll('.main');
    var list_searche = document.querySelectorAll('.anime_list_searche');

    // Переключаем видимость для каждого элемента
    ...
    list_searche.forEach(function(element) {
        if (element.style.display === 'none') {
            element.style.display = '';
        } else {
            element.style.display = '';
